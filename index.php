...
<body class='alg' style="background-color:#FFE4B5">
    <input id="alg" name="radio" type="radio" value="alg_kor">
    <table style="background-color:#FFE4B5" id="tb_1"  width=100% border=0px>
        <tr>
            <form id="query1" method="post" action="" name="query1">
            <td align="left"><b>АЛГЕБРА</b></td>
...
<script type="text/javascript" src="handlersButton.js"></script>
<script type="text/javascript" src="handlersSelects.js"></script>
</body>
</html>
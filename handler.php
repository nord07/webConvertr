...
//Если нажали кнопку Принять запрос
    if($Button == "Принять запрос") {
        ...
        $sql = "SELECT * FROM `queryalgb` where NameQuery = '$optionActive'";
...
//Если нажали кнопку Сохранить запрос
    if($Button == "Сохранить запрос"){
        ...
        $sql = "INSERT INTO QueryAlgb (`NameQuery`, `TableVar`, `GoalList`, `QueryBody`, `DescQuery`) VALUES ('"
            . $nameQuery ."', '" 
            . $tv ."', '" 
            . $tl ."', '" 
            . $qb ."', '" 
...
//Если нажали кнопку Удалить запрос
    if($Button == "Удалить запрос"){
        ...
        $sql = "DELETE FROM queryalgb WHERE NameQuery='$nameQuery'";
        $result_query = mysqli_query($conn, $sql);
    }
